...
•	Class Statistics: 
o	Total marks for each subject
o	Average marks for each subject
o	Overall class performance
...
o	Input school name, teacher name, grade, and year when prompted
2.	Specify Number of Students
o	Enter the number of students (minimum 12)
o	System will prompt again if less than 12
3.	Input Student Data
o	For each student, enter: 
	Student name
	Marks for all 6 subjects (English, Maths, History, Geography, Science, Programming)
4.	View Generated Report
o	System automatically calculates and displays: 
